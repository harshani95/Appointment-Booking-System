    ...
    <>
      <div className="max-w-md mx-auto bg-white p-5 rounded-2xl shadow-lg border border-gray-200 mt-4">
        ...
        <form className="space-y-3">
          ...
          {/* <span className="text-blue-700 font-medium underline flex flex-row justify-end items-end">
            <Link to={"/calander"}> Calender</Link>
          </span> */}

          <button
            type="submit"
            className="w-full py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-lg shadow-md hover:from-cyan-600 hover:to-blue-600 transition duration-300 transform hover:scale-105"
